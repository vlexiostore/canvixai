...
import CreativeAIChatPage from './CreativeAIChatPage';
import NanoBananaEditorPage from './NanoBananaEditorPage';
...
export default function CreativeStudioPage({ user }) {
  ...
  if (activeMode === 'chat') {
    return <CreativeAIChatPage user={user} onSwitchMode={() => setActiveMode('editor')} />;
  }
