			...
			<div id="pricing" className="mx-auto w-full max-w-6xl space-y-5 px-4">
				...
				>
					<div className="flex justify-center">
						<div className="rounded-lg border border-white/10 px-4 py-1 font-mono text-white/60 text-sm">Pricing</div>
					</div>
					...
					<p className="mt-5 text-center text-sm text-white/40 md:text-base">
						Simple, transparent pricing. No hidden fees. Start free and scale as you create.
					</p>
				</motion.div>
				...
				<div className="relative">
					...
					>
						<div className="grid md:grid-cols-2 relative border border-white/10 bg-white/[0.02] p-4 rounded-xl">
								...
								<div className="space-y-1">
									<div className="flex items-center justify-between">
										...
										<div className="flex items-center gap-x-1">
											<span className="text-white/30 text-sm line-through">$14.99</span>
											<Badge variant="secondary" className="bg-white/10 text-white/60 border-white/10">20% off</Badge>
										</div>
									</div>
									<p className="text-white/40 text-sm">500 credits. For serious creators.</p>
								</div>
							...
							<div className="relative w-full rounded-lg border border-white/10 bg-white/[0.03] px-4 pt-5 pb-4">
								<BorderTrail
									...
									style={{
										boxShadow:
											'0px 0px 60px 30px rgba(168, 85, 247, 0.4), 0 0 100px 60px rgba(168, 85, 247, 0.2), 0 0 140px 90px rgba(0, 0, 0, 0.3)',
									}}
									size={100}
								/>
								<div className="space-y-1">
									<div className="flex items-center justify-between">
										...
										<div className="flex items-center gap-x-1">
											<span className="text-white/30 text-sm line-through">$12</span>
											<Badge className="bg-purple-500/20 text-purple-300 border-purple-500/30">33% off</Badge>
										</div>
									</div>
									<p className="text-white/40 text-sm">Best value. Save $48 per year!</p>
								</div>
								<div className="mt-10 space-y-4">
